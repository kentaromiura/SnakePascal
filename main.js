...
rtl.module("Generics.Defaults",["System"],function () {
  "use strict";
  var $mod = this;
  rtl.createInterface(this,"IComparer$G19","{505778ED-F783-4456-9691-32F419CC5E18}",["Compare"],pas.System.IUnknown,"IComparer<System.String>");
});
rtl.module("Generics.Collections",["System","Classes","SysUtils","RTLConsts","Types","JS","Generics.Strings","Generics.Defaults"],function () {
  ...
  },"TEnumerator<snaketypes.PositionType>");
  rtl.createClass(this,"TEnumerable$G17",pas.System.TObject,function () {
  },"TEnumerable<snaketypes.PositionType>");
  rtl.createClass(this,"TCustomList$G10",this.TEnumerable$G17,function () {
    ...
    this.PrepareAddingItem = function () {
      var Result = 0;
      if (this.FLength === rtl.length(this.FItems)) this.FItems.push(pas.snaketypes.PositionType.$new());
      Result = this.FLength;
      this.FLength += 1;
      return Result;
    };
  ...
  },"TCustomList<snaketypes.PositionType>");
  rtl.createClass(this,"TCustomListEnumerator$G8",this.TEnumerator$G18,function () {
    ...
    this.DoGetCurrent = function () {
      var Result = pas.snaketypes.PositionType.$new();
  ...
  },"TCustomListEnumerator<snaketypes.PositionType>");
  rtl.createClass(this,"TList$G3",this.TCustomList$G10,function () {
    ...
    },"TList<snaketypes.PositionType>.TEnumerator");
    this.SetCapacity = function (AValue) {
      if (AValue < this.FLength) this.SetCount(AValue);
      this.FItems = rtl.arraySetLength(this.FItems,pas.snaketypes.PositionType,AValue);
    };
  ...
  },"TEnumerable<Generics.Collections.TPair<System.String,snaketypes.DirectionType>>");
  rtl.createClass(this,"TEnumerable$G19",pas.System.TObject,function () {
  },"TEnumerable<snaketypes.DirectionType>");
  ...
  rtl.createClass(this,"TDictionary$G2",this.TEnumerable$G18,function () {
    rtl.createClass(this,"TValueCollection",$mod.TEnumerable$G19,function () {
    },"TDictionary<System.String,snaketypes.DirectionType>.TValueCollection");
    rtl.createClass(this,"TKeyCollection",$mod.TEnumerable$G20,function () {
    },"TDictionary<System.String,snaketypes.DirectionType>.TKeyCollection");
    this.$init = function () {
  ...
  },"TDictionary<System.String,snaketypes.DirectionType>");
  rtl.createClass(this,"TObjectDictionary$G1",this.TDictionary$G2,function () {
    this.$init = function () {
      $mod.TDictionary$G2.$init.call(this);
      this.FOwnerships = {};
    };
    this.$final = function () {
      this.FOwnerships = undefined;
      $mod.TDictionary$G2.$final.call(this);
    };
    this.CanClearMap = function () {
      var Result = false;
      Result = $mod.TDictionary$G2.CanClearMap.call(this) && rtl.eqSet(this.FOwnerships,{});
      return Result;
    };
    this.KeyNotify = function (Key, Action) {
      $mod.TDictionary$G2.KeyNotify.call(this,Key,Action);
      if (($mod.TDictionaryOwnership.doOwnsKeys in this.FOwnerships) && (Action === $mod.TCollectionNotification.cnRemoved)) Key = rtl.freeLoc(Key);
    };
    this.ValueNotify = function (Value, Action) {
      $mod.TDictionary$G2.ValueNotify.call(this,Value,Action);
      if (($mod.TDictionaryOwnership.doOwnsValues in this.FOwnerships) && (Action === $mod.TCollectionNotification.cnRemoved)) Value = rtl.freeLoc(Value);
    };
  },"TObjectDictionary<System.String,snaketypes.DirectionType>");
  $mod.$implcode = function () {
    $mod.$resourcestrings = {SErrDictKeyNotFound: {org: "Key value not found"}, SErrDictDuplicateKey: {org: "Duplicate key value"}};
  };
},[]);
rtl.module("snaketypes",["System","Generics.Collections"],function () {
  "use strict";
  var $mod = this;
  this.DirectionType = {"0": "Up", Up: 0, "1": "Down", Down: 1, "2": "Left", Left: 2, "3": "Right", Right: 3};
  rtl.recNewT(this,"PositionType",function () {
    this.x = 0;
    this.y = 0;
    this.$eq = function (b) {
  ...
  rtl.recNewT(this,"NodeType",function () {
    this.direction = 0;
    this.next = null;
    this.$new = function () {
      var r = Object.create(this);
      r.position = $mod.PositionType.$new();
      return r;
    };
    this.$eq = function (b) {
      return this.position.$eq(b.position) && (this.direction === b.direction) && (this.next === b.next);
    };
    this.$assign = function (s) {
...
rtl.module("snake",["System","snaketypes","SysUtils"],function () {
  "use strict";
  var $mod = this;
  this.SnakeStatus = {"0": "Alive", Alive: 0, "1": "Dead", Dead: 1};
  rtl.createClass(this,"Snake",pas.System.TObject,function () {
    this.$init = function () {
      pas.System.TObject.$init.call(this);
      this.head = pas.snaketypes.NodeType.$new();
      this.tail = null;
      this.status = 0;
    };
    this.$final = function () {
    ...
    var initialPosition = pas.snaketypes.PositionType.$clone({x: 9, y: 9});
    this.Create$1 = function () {
      pas.System.TObject.Create.call(this);
      var $with = this.head;
      $with.position.$assign(initialPosition);
      $with.direction = pas.snaketypes.DirectionType.Right;
      $with.next = null;
      this.tail = this.head;
      this.status = $mod.SnakeStatus.Alive;
      return this;
    };
    this.Destroy = function () {
      pas.System.TObject.Destroy.call(this);
    ...
    this.GetPositions = function () {
      ...
      var positions = null;
      var current = null;
      positions = pas["Generics.Collections"].TList$G3.$create("Create$1");
      current = this.head;
      while (current !== null) {
    ...
    this.isAlive = function () {
      var Result = false;
      Result = this.status === $mod.SnakeStatus.Alive;
      return Result;
    };
    this.Grow = function () {
      var newPosition = pas.snaketypes.PositionType.$new();
      var next = null;
      newPosition.$assign(this.tail.position);
      var $tmp = this.tail.direction;
      if ($tmp === pas.snaketypes.DirectionType.Up) {
        newPosition.y = newPosition.y + 1}
       else if ($tmp === pas.snaketypes.DirectionType.Down) {
        newPosition.y = newPosition.y - 1}
       else if ($tmp === pas.snaketypes.DirectionType.Left) {
        newPosition.x = newPosition.x + 1}
       else if ($tmp === pas.snaketypes.DirectionType.Right) newPosition.x = newPosition.x - 1;
      next = pas.snaketypes.NodeType.$new();
      this.tail.next = next;
      next.position.$assign(newPosition);
      next.direction = this.tail.direction;
      next.next = null;
      this.tail = next;
    };
    this.Move = function (directions) {
      ...
      var key = "";
      current = this.head;
      if (this.status === $mod.SnakeStatus.Alive) {
        while (current !== null) {
          key = pas.SysUtils.Format("%d-%d",pas.System.VarRecs(0,current.position.x,0,current.position.y));
          if (directions.ContainsKey(key)) {
            current.direction = directions.GetItem(key);
            if (current.next === null) {
              directions.Remove(key);
            };
          };
          var $tmp = current.direction;
          if ($tmp === pas.snaketypes.DirectionType.Up) {
           ...
           else if ($tmp === pas.snaketypes.DirectionType.Right) current.position.x = current.position.x + 1;
          if (this.isOutOfBounds(pas.snaketypes.PositionType.$clone(current.position))) {
            this.Kill();
          };
          if (!current.$eq(this.head)) {
            if ((current.position.x === this.head.position.x) && (current.position.y === this.head.position.y)) {
              this.Kill();
            };
          };
          current = current.next;
    ...
    this.Kill = function () {
      this.status = $mod.SnakeStatus.Dead;
    };
    this.isOutOfBounds = function (position) {
      var Result = false;
      Result = false;
      if ((position.x < 0) || (position.y < 0)) Result = true;
      if ((position.x > 19) || (position.y > 19)) Result = true;
      return Result;
    };
  });
});
rtl.module("program",["System","Web","SysUtils","snaketypes","snake"],function () {
  "use strict";
  var $mod = this;
  this.GameStatus = {"0": "Running", Running: 0, "1": "Paused", Paused: 1, "2": "GameOver", GameOver: 2};
  this.canvas = null;
  this.shadow = null;
  this.ctx = null;
  this.snek = null;
  ...
  this.status = this.GameStatus.Paused;
  this.currentFood = pas.snaketypes.PositionType.$new();
  this.AnimateDeath = function (ctx, positions) {
    function render(pos, index, delta) {
      ctx.fillStyle = pas.SysUtils.Format("rgb(%d,0,%d)",pas.System.VarRecs(0,255 - (index * delta),0,255 - (index * delta)));
      ctx.fillRect(17 + (pos.x * 24),17 + (pos.y * 24),22,22);
    };
    function renderHead(pos) {
      ctx.fillStyle = "yellow";
      ctx.fillRect(17 + (pos.x * 24),17 + (pos.y * 24),22,22);
    };
    var position = pas.snaketypes.PositionType.$new();
    var index = 0;
    index = 0;
    var $in = positions.GetEnumerator$1();
    try {
      while ($in.MoveNext()) {
        position = $in.DoGetCurrent();
        if (index === 0) {
          renderHead(pas.snaketypes.PositionType.$clone(position));
          index += 1;
        } else {
          render(pas.snaketypes.PositionType.$clone(position),index,rtl.trunc((255 - 55) / positions.FLength));
          index += 1;
        };
      }
    } finally {
  ...
  this.DrawSnake = function (ctx, positions) {
    function render(pos, index, delta) {
      ctx.fillStyle = pas.SysUtils.Format("rgb(%d,0,0)",pas.System.VarRecs(0,255 - (index * delta)));
      ctx.fillRect(17 + (pos.x * 24),17 + (pos.y * 24),22,22);
    };
    function renderHead(pos) {
      ctx.fillStyle = "green";
  ...
  this.MoveAndDraw = function (snek, ctx, directions) {
    var positions = null;
    ...
    if (snek.isAlive()) {
      ...
      $mod.DrawSnake(ctx,positions);
    } else {
      $mod.AnimateDeath(ctx,oldPositions);
    };
  };
  this.DrawFood = function (ctx, currentFood) {
    ctx.fillStyle = "lightsteelblue";
    ctx.fillRect(17 + (currentFood.x * 24),17 + (currentFood.y * 24),22,22);
  };
  this.DrawField = function (ctx) {
    ctx.drawImage($mod.backgroundImage,0,0);
  };
  this.SetUpField = function (ctx) {
    var i = 0;
    var j = 0;
    ctx.fillStyle = "black";
    ...
    for (i = 0; i <= 19; i++) {
      for (j = 0; j <= 19; j++) {
        ctx.beginPath();
        ctx.moveTo(16 + (j * 24),16 + (i * 24));
        ctx.lineTo(16 + (j * 24) + 24,16 + (i * 24));
        ctx.lineTo(16 + (j * 24) + 24,16 + (i * 24) + 24);
        ctx.lineTo(16 + (j * 24),16 + (i * 24) + 24);
        ctx.lineTo(16 + (j * 24),16 + (i * 24));
        ctx.stroke();
      };
    };
    $mod.backgroundImage = new Image(512,512);
    $mod.backgroundImage.src = $mod.canvas.toDataURL();
  };
  this.isOppositeDirection = function (direction1, direction2) {
    var Result = false;
    Result = false;
    var $tmp = direction1;
    if ($tmp === pas.snaketypes.DirectionType.Left) {
      Result = direction2 === pas.snaketypes.DirectionType.Right}
     else if ($tmp === pas.snaketypes.DirectionType.Right) {
      Result = direction2 === pas.snaketypes.DirectionType.Left}
     else if ($tmp === pas.snaketypes.DirectionType.Up) {
      Result = direction2 === pas.snaketypes.DirectionType.Down}
     else if ($tmp === pas.snaketypes.DirectionType.Down) Result = direction2 === pas.snaketypes.DirectionType.Up;
    return Result;
  };
  this.OnSwipe = function (event) {
    ...
    function setDirection(x, y, direction) {
      var Result = false;
      var key = "";
      if ($mod.status === $mod.GameStatus.Running) {
        key = pas.SysUtils.Format("%d-%d",pas.System.VarRecs(0,x,0,y));
        if ($mod.directions.ContainsKey(key)) {
          $mod.directions.SetItem(key,direction);
        } else {
          $mod.directions.Add(key,direction);
        };
        return Result;
      };
      return Result;
    ...
    var $tmp = direction;
    if ($tmp === "left") {
      swipeDirection = pas.snaketypes.DirectionType.Left}
     else if ($tmp === "right") {
      swipeDirection = pas.snaketypes.DirectionType.Right}
     else if ($tmp === "up") {
      swipeDirection = pas.snaketypes.DirectionType.Up}
     else if ($tmp === "down") swipeDirection = pas.snaketypes.DirectionType.Down;
    x = $mod.snek.head.position.x;
    y = $mod.snek.head.position.y;
    if (!$mod.isOppositeDirection($mod.snek.head.direction,swipeDirection)) {
      setDirection(x,y,swipeDirection);
    };
    if ($mod.status === $mod.GameStatus.Paused) {
      $mod.status = $mod.GameStatus.Running;
    };
    Result = true;
    return Result;
  };
  this.OnKeyUp = function (event) {
    ...
    if ($tmp === "Escape") {
      if ($mod.status === $mod.GameStatus.Running) {
        $mod.status = $mod.GameStatus.Paused;
      } else {
        $mod.status = $mod.GameStatus.Running;
      };
    } else if ($tmp === "ArrowUp") {
      if ($mod.snek.head.direction !== pas.snaketypes.DirectionType.Down) setDirection(x,y,pas.snaketypes.DirectionType.Up);
    } else if ($tmp === "ArrowDown") {
      if ($mod.snek.head.direction !== pas.snaketypes.DirectionType.Up) setDirection(x,y,pas.snaketypes.DirectionType.Down);
    } else if ($tmp === "ArrowLeft") {
      if ($mod.snek.head.direction !== pas.snaketypes.DirectionType.Right) setDirection(x,y,pas.snaketypes.DirectionType.Left);
    } else if ($tmp === "ArrowRight") {
      if ($mod.snek.head.direction !== pas.snaketypes.DirectionType.Left) setDirection(x,y,pas.snaketypes.DirectionType.Right);
    };
    if ((event.key !== "Escape") && ($mod.status === $mod.GameStatus.Paused)) {
      $mod.status = $mod.GameStatus.Running;
    };
    Result = true;
    return Result;
  };
  this.NotInSnake = function (x, y) {
    var Result = false;
    var pos = pas.snaketypes.PositionType.$new();
    Result = true;
    var $in = $mod.snek.GetPositions().GetEnumerator$1();
    try {
      while ($in.MoveNext()) {
        pos = $in.DoGetCurrent();
        if ((pos.x === x) && (pos.y === y)) {
  ...
  this.SpawnFood = function () {
    ...
    var y = 0;
    do {
      x = pas.System.Random(20);
      y = pas.System.Random(20);
    } while (!$mod.NotInSnake(x,y));
    Result.x = x;
    Result.y = y;
    return Result;
  };
  this.PauseScreen = function (ctx) {
  ...
  this.StartNewGame = function () {
    $mod.snek = pas.snake.Snake.$create("Create$1");
    $mod.snek.Grow();
    $mod.currentFood.$assign($mod.SpawnFood());
  };
  $mod.$main = function () {
    $mod.canvas = document.getElementById("field");
    $mod.shadow = document.getElementById("shadow");
    document.onkeyup = rtl.createSafeCallback($mod,"OnKeyUp");
    document.addEventListener("swiped",$mod.OnSwipe);
    $mod.ctx = $mod.canvas.getContext("2d");
    $mod.directions = pas["Generics.Collections"].TObjectDictionary$G1.$create("Create$1",[0]);
    $mod.StartNewGame();
    ...
    $mod.SetUpField($mod.ctx);
    window.setInterval(function () {
      if ($mod.status === $mod.GameStatus.Running) {
        if ($mod.snek.isAlive()) {
          $mod.DrawField($mod.ctx);
          if ($mod.NotInSnake($mod.currentFood.x,$mod.currentFood.y)) {
            $mod.DrawFood($mod.ctx,pas.snaketypes.PositionType.$clone($mod.currentFood));
          } else {
            $mod.snek.Grow();
            $mod.currentFood.$assign($mod.SpawnFood());
            $mod.DrawFood($mod.ctx,pas.snaketypes.PositionType.$clone($mod.currentFood));
          };
          $mod.MoveAndDraw($mod.snek,$mod.ctx,$mod.directions);
        };
      } else {
        $mod.PauseScreen($mod.ctx);
      };
    },128);
  };
});
